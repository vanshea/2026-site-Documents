      ...
      <div className="overflow-hidden rounded-[30px] border border-border/80 bg-white shadow-card">
        ...
        <div className="space-y-6 px-6 py-6 md:px-10 md:py-8">
          {content.slides.length === 0 ? (
            <section className="rounded-[28px] border border-dashed border-border bg-[#fcfdfc] p-6 text-sm leading-7 text-inkSoft md:p-7">
              No slides yet. Add content to <code>/content/clients/{content.clientId}.json</code> after
              ...
              >
                ...
                {slide.image ? (
                  ...
                  <div className="rounded-[24px] border border-dashed border-border bg-white/70 p-5 text-sm leading-6 text-inkSoft">
                    ...
                    it with <code>"image.asset"</code> in <code>/content/clients/{content.clientId}.json</code>.
                  </div>
                )}
              </section>
            ))
